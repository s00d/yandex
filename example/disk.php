...
//}
//
//$has_moved = $resource->move('image2.jpg', true); // переместить, boolean
//$result = $resource->upload('http://<..>file.zip');
//var_dump($result->getStatus(), $result->getIdentifier());
//
//$result = $resource->setPublish(true);
//var_dump("PB");
//var_dump($result->public_url);
//
...
//$resource = $disk->getPublishResource('https://disk.yandex.ru/i/t9j_N--kEPo8kQ');
